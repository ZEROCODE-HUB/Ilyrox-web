...
const r2Client = new S3Client({
  ...
  credentials: {
    accessKeyId: import.meta.env.VITE_PUBLIC_R2_ACCESS_KEY!,
    secretAccessKey: import.meta.env.VITE_PUBLIC_R2_SECRET_ACCESS_KEY!,
  },
});
  ...
  while (attempt < retries) {
    try {
      ...
      if (typeof fileOrUri === "string") {
        throw new Error(
          "Upload of string URIs not fully implemented for web in this version. Please pass a File object.",
        );
      } else {
