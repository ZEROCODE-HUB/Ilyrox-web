...
export function PropertyDetail({
  ...
  const [displayProperty, setDisplayProperty] = useState<PropertyView | null>(
    property,
  );
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={`${displayProperty.tipo.charAt(0).toUpperCase() + displayProperty.tipo.slice(1)} en ${displayProperty.municipio}`}
      size="full"
    >
      <>
                  ...
                  <div className="text-center mb-4">
                    ...
                    <p className="text-muted-foreground text-sm">
                      {displayProperty.asesor_rol.charAt(0).toUpperCase() +
                        displayProperty.asesor_rol.slice(1) || "Asesor"}
                    </p>
                  </div>
